...
export const site = {
  ...
  title: "개인회생 변호사 김훈찬 | 법무법인 에이파트 회생파산센터",
  description:
    "개인회생 변호사 김훈찬이 직접 상담합니다. 서울 송파 법무법인 에이파트 회생파산센터 — 2천명 이상의 개인회생·개인파산 노하우로 빚 걱정 없는 새 출발을 돕습니다. 무료 상담 02-421-0508.",
  keywords: [
    "개인회생 변호사",
    "개인회생",
    "개인회생 상담",
  ...
  url: "https://www.a-part-kimhc.co.kr",
  // 구조화 데이터(JSON-LD)용 정보
  telephone: "02-421-0508",
  address: {
    street: "백제고분로 365, 9층 (석촌동, 태문빌딩)",
    locality: "서울특별시",
    region: "송파구",
    country: "KR",
  },
